...
Serial.println("✅ Dhaniya Detection System Ready");
}
...
// -------- DHANIYA DETECTION LOGIC --------
String result;
int resultValue;

if (ratioGR > 0.7 && ratioGR < 1.0 && ratioBR < 0.6 && gasValue > 2000) {
result = "PURE DHANIYA";
resultValue = 1;
} else {
result = "ADULTERATED DHANIYA";
resultValue = 0;
}

// -------- SERIAL OUTPUT --------
Serial.println("----- DHANIYA DATA -----");
...
delay(20000); // important for ThingSpeak
}
